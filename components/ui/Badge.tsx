...
export default function Badge({
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[11px] font-black uppercase tracking-wider border ${colorCls[color]} ${className}`}>
      {dot && (
