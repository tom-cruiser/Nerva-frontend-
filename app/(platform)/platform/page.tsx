...
export default function PlatformAdminPage() {
  return (
    <div className="flex-1 overflow-y-auto p-7 space-y-6 bg-zinc-50/50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
        ...
        <div className="bg-white/70 backdrop-blur-md border border-zinc-200/50 rounded-2xl p-5 flex items-center justify-between hover:-translate-y-1 transition-all duration-300 shadow-sm">
          <div>
            ...
            <span className="text-[11px] font-bold text-amber-600 bg-amber-50/80 px-2.5 py-0.5 rounded-full mt-2 inline-block border border-amber-200/30 animate-pulse">load index</span>
          </div>
          <div className="relative w-14 h-14 flex items-center justify-center">
            <svg className="w-full h-full transform -rotate-90" viewBox="0 0 36 36">
              <path className="text-zinc-100" strokeWidth="3.5" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
      ...
      <div className="bg-white/70 backdrop-blur-md rounded-2xl overflow-hidden shadow-[0_16px_48px_-12px_rgba(0,0,0,0.08)] border border-white/60">
        <div className="px-6 py-4 border-b border-zinc-200/40 flex justify-between items-center bg-white/40">
          <h2 className="text-xs font-bold uppercase tracking-[0.15em] text-zinc-600 flex items-center gap-2.5">
            <Database className="text-[#0052ff]" size={16} strokeWidth={2.5} />
          ...
          <div className="flex gap-2.5">
            ...
            <button className="border border-zinc-200/60 bg-white/60 text-zinc-500 p-2.5 rounded-xl hover:bg-zinc-50 transition-all shadow-sm">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-zinc-100/60 text-xs font-medium text-zinc-700">
              ...
              {/* Row 1 */}
              <tr className="hover:bg-[#0052ff]/[0.02] hover:shadow-[inset_4px_0_0_0_#0052ff] transition-all cursor-default group">
                ...
                <td className="px-6 py-4">
                  <span className="px-3 py-1 text-[9px] font-extrabold bg-blue-50 text-blue-700 border border-blue-200/20 rounded-full tracking-wider">ENTERPRISE</span>
                </td>
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex justify-end gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button className="p-1.5 hover:bg-zinc-100/80 rounded-xl text-zinc-400 hover:text-zinc-800 transition-colors" title="Upgrade">
                      <ArrowUp size={16} strokeWidth={2.5} />
                    </button>
                    <button className="p-1.5 hover:bg-zinc-100/80 rounded-xl text-zinc-400 hover:text-rose-600 transition-colors" title="Suspend">
              ...
              <tr className="hover:bg-[#0052ff]/[0.02] hover:shadow-[inset_4px_0_0_0_#0052ff] transition-all cursor-default group">
                ...
                <td className="px-6 py-4">
                  <span className="px-3 py-1 text-[9px] font-extrabold bg-zinc-100 text-zinc-700 border border-zinc-200/20 rounded-full tracking-wider">PROFESSIONAL</span>
                </td>
        ...
        <div className="px-6 py-3.5 bg-white/40 border-t border-zinc-200/30 flex justify-between items-center text-xs text-zinc-500 font-bold uppercase tracking-wider">
          <p className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[#0052ff]/20 animate-pulse"></span> 
            Showing 3 of 1,284 metric points
          </p>
          <div className="flex items-center gap-1.5">
            <button className="p-2 rounded-xl border border-zinc-200/60 bg-white/60 hover:bg-zinc-50 transition-colors shadow-sm text-zinc-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <div className="lg:col-span-2 bg-white/70 backdrop-blur-md rounded-2xl p-5 shadow-[0_12px_40px_-12px_rgba(0,0,0,0.06)] border border-white/60">
          <div className="flex justify-between items-center mb-4 border-b border-zinc-200/30 pb-3">
            <h3 className="text-[10px] font-bold uppercase tracking-[0.15em] text-zinc-400 flex items-center gap-2">
              <RotateCw className="text-[#0052ff] animate-spin-slow" size={12} strokeWidth={2.5} />
              Telemetry real-time stream
            </h3>
            <button className="text-zinc-400 text-[10px] hover:text-zinc-800 transition-colors font-bold uppercase tracking-wider flex items-center gap-1.5">
              Expand 
        ...
        {/* Micro chart */}
        <div className="bg-white/70 backdrop-blur-md rounded-2xl p-5 relative overflow-hidden flex flex-col justify-between shadow-[0_12px_40px_-12px_rgba(0,0,0,0.06)] border border-white/60">
          ...
          <div className="mt-3 flex justify-between text-[9px] text-zinc-400 font-mono font-bold tracking-widest">
            <span>08:00</span>
            <span className="text-[#0052ff] flex items-center gap-1">
